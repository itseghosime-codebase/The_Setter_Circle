      ...
      <div className="container">
        <div className="grid md:grid-cols-5 items-center gap-10 lg:gap-20 w-full">
          ...
          <section className="md:col-span-2 space-y-3">
            <div className="border-4 w-full mx-auto max-w-2xs rounded-3xl border-primary bg-[#1c1c1c] h-80 relative"></div>
            <div className="py-4 px-12 w-full mx-auto max-w-2xs text-center rounded-xl text-xl bg-primary/10 border border-primary text-primary font-medium font-mont">
