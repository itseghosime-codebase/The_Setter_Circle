...
import LogoIcon from "@/assets/background/icon.svg";
  ...
  return (
    <div className="relative">
      <div className="container max-w-4xl pt-40 pb-20 lg:min-h-[700px] flex items-center justify-center relative z-10">
        <section className="text-center space-y-3">
          ...
          <p className="text-sm md:text-base lg:text-xl font-normal font-sans">
            ...
            on what you do best — closing deals. While you're busy scaling, our
            setters are actively starting conversations, qualifying leads, and
            booking calls straight into your calendar.
          </p>
      ...
      <Image
        ...
        sizes="100%"
        fill
        className="h-full w-full absolute z-[5] object-cover md:object-contain object-center"
      />
    </div>
  );
}
